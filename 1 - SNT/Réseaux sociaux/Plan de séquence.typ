...
#let début_séance = phase_séance(
    "Début de cours",
    "/",
    "5-10m",
    "Arrivé en classe, appel et questions flash/quiz",
    "Tableau",
)
...
#planning_séance(
    ...
    ..phase_séance(
        "Activité charactéristique et revenu des réseaux sociaux",
        "B, C",
        "30m",
        "En binôme, les élèves iront se renseigner sur un réseau social en particulier, son fonctionnement et ses sources de revenu",
        "Internet, fiche d'activité",
    ),
    ..phase_séance(
        "Activité confidentialité",
        "B",
        "30m",
        "Étude de plusieurs documents lié à l'identité numérique et la confidentialité.",
        "Fiche d'activité",
    ),
    ..phase_séance(
        "Institutionalisation et exercices",
        "A, B, C",
        "45m",
        "Partie sur les caractéristiques des réseaux sociaux, les modèles économique des réseaux sociaux et l'idendité numérique et sa protection.",
...
#planning_séance(
    ...
    ..phase_séance(
        ...
        "A, F",
        "30m",
        "Travail de recherche et de réflexion sur le cyberviolence, qui se conclura par un mini débat avec la classe",
        "Internet, fiche d'activité",
    ),
    ..phase_séance(
        ...
        "A, F",
        "15m",
        "Partie sur les différentes formes de cyberviolence et de prévention",
        "Tableau, fiche de cours",
    ),
    ..fin_séance,
)
...
#planning_séance(
    ..début_séance,
    ..phase_séance(
        "Activité petit monde et découverte des graphes",
        "D, E",
        "40m",
        "Par binôme, les élèves reproduirons une expérience du petit monde sur le web, puis découvriront les graphes via la représentation d'un réseau social",
        "Internet, fiche d'activité",
    ),
    ...
    ..phase_séance(
        ...
        "B, D, E",
        "50m",
        "Partie sur les graphes, la représentation des réseaux sociaux et l'importance des abonnements pour assurer sa confidentialité",
        "Tableau, fiche de cours",
    ),
    ..fin_séance,
)
...
#planning_séance(
    ..début_séance,
    ..phase_séance(
        "Activité représentation mathématique d'un réseau social",
        "D, T1",
        "45m",
        "Activité avec une matrice d'adjacence, de l'algorithmie et de la programmation. L'activité est ramassée et notée.",
        "PC, fichier source, IDE",
    ),
    ..fin_séance,
)
