...
#sous_titre[SNT - Réseaux Sociaux - Activité]
#v(-1em)
#titre[Recherches sur la cyberviolence]
...
#grid(
    columns: 2,
    column-gutter: 10pt,
    image(height: 229pt, "./photoperso.jpg"),
    grid(rows: 2, loi, align(center, image(height: 75pt, "./non_au_harcelement.jpg"))),
)
