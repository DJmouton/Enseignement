...
#let figure_identité_numérique(parts) = align(center, cetz.canvas({
  import cetz.draw: line, content

  content((0, 0), text(size: 45pt, emoji.person))

  let texte_ligne(départ: (0, 0), arrivée: (1, 1), distance_coude: 0.5, titre: "Titre", sous_titre: "sous-titre") = {
