...
#exocounter.step()
#let exo(nbline, body) = cadre(titre: context([Exercice #exocounter.step() #exocounter.display()]))[#body #for i in range(nbline) [#v(1em) #line(length: 100%, stroke: (thickness: 1pt, dash: "dotted"))]]
...
#exo(2)[
  ...
  #table(columns: 7, "id", "nom","désignation", "encadre", "recruté le", "salaire", "département", "8", "Turing", "Tech", "6", "2022/05/04", "33000", "3")
]
