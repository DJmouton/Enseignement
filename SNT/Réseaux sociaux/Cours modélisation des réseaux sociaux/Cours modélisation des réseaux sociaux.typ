...
#cadre(titre: "L'essentiel")[
  #correction(énoncé: pointillets(repeat: 3))[Dans un réseau social, une personne est représentée par un cercle ou un point numéroté appelé *sommet*.
...
#grid(
  ...
  [], align(center, [*Le graphe taureau*]), align(center, [*Le graphe de Petersen*]), align(center, [*Le graphe criquet*]),
...
#cadre(titre: "L'essentiel")[
  #correction(énoncé: pointillets(repeat: 2))[La *distance* entre deux sommets est égale à la longueur du plus court "chemin" entre ces sommets. Ce nombre n'a pas d'unité.]
]
...
#cadre(titre: "L'essentiel")[
  ...
  #correction(énoncé: pointillets(repeat: 6))[- Le *rayon* du graphe est la plus petite distance à laquelle un des sommets se trouve de touts les autres.
